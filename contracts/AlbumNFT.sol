...
contract AlbumNFT is ERC721URIStorage{
    ...
    function createSong(string memory _name, string memory tokenUri) public onlyArtist returns(uint){
        _tokenCount++;
    ...
    function setSongToTrackList(uint songNum, uint trackSpot) public onlyArtist returns(bool){
